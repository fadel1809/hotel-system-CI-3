        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <a class="navbar-brand" href="<?= base_url('mainpage') ?>">Hotel Pantai</a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page" href="<?= base_url('mainpage') ?>">Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('/mainpage/konfirmasi') ?>" class="nav-link ">
                                    <b>Konfirmasi</b> </a>
                            </li>
                            <li class="nav-item">
                                <div class="dropdown">
                                    <a class="nav-link  dropdown-toggle" href="#" role="button"
                                        ...
                                        Halo, <?= $this->session->userdata('firstname') ?>
                                    </a>

                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="<?= base_url('mainpage/logout') ?>">Logout</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="#room"
                            class="btn btn-outline-light animate__animated animate__fadeInUp pesan-skrg">Pesan
                            Sekarang</a>
                    </div>
                </div>
            </div>
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="100">
                            <img src="<?= base_url('assets/images/pool.jpg') ?>" class="d-block w-100 shadow-lg"
                                alt="...">
                        ...
                        <div class="carousel-item " data-bs-interval="100">
                            <img src="<?= base_url('assets/images/gym.jpg') ?>" class="d-block w-100 shadow-lg"
                                alt="...">
                            <div class="carousel-caption d-none d-md-block rounded-2 shadow-lg">
                                <h5>Gym</h5>
                        ...
                        <div class="carousel-item " data-bs-interval="100">
                            <img src="<?= base_url('assets/images/restoran.jpg') ?>" class="d-block w-100 shadow-lg"
                                alt="...">
                            <div class="carousel-caption d-none d-md-block rounded-2 shadow-lg">
                                <h5>Restoran</h5>
