                ...
                <a href="<?= base_url('mainpage') ?>" class="btn btn-danger mt-3 mb-3"><i class="fa-solid fa-arrow-left"></i> Kembali ke dahsboard</a>
                    ...
                    <table class="table text-center table-striped">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            if(!$checkout){
                                echo "<p class='alert alert-danger text-center mt-5 mb-5'>Tidak ada tamu</p>";
                            }else{    
                            foreach ($checkout as $trans){
                            ?>
                            <tr>
                                <td><?= $i++ ?></td>
                                <td><?= $trans->id ?></td>
                                ...
                                <td> <a href="<?= base_url('guest/inventaris/'.$trans->id) ?>" class="btn btn-danger"><i class="fa-solid fa-door-open"></i> Check Out</a> </td>
