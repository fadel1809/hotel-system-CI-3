...
<section id="navbar-admin">
    ...
    <section id="data-pengguna">
            <div class="container">
                ...
                <a href="<?= base_url('mainpage') ?>" class="btn btn-danger  mt-3"><i class="fa-solid fa-arrow-left"></i> Kembali ke dahsboard</a>
                    ...
                    <table class="table text-center table-striped">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            if(!$result){
                                echo "<p class='alert alert-danger text-center mt-5 mb-5'>Tidak ada data transaksi yang pending</p>";
                            }else{    
                            ...
                            <tr>
                                ...
                                <td><?= $trans->notelp ?></td>
                                <td><?=$trans->status  ?></td>
                                <td> <a href="<?= base_url('Transaksi/confirm') ?>/<?= $trans->id ?>" class="btn btn-success">Confirm</a></td>
                            </tr>
                            <?php  } ?>
                            <?php } ?>
                        </tbody>
